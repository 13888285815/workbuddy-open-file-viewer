...
// ../node_modules/.pnpm/xz-decompress@0.2.3/node_modules/xz-decompress/dist/package/xz-decompress.js
var require_xz_decompress = __commonJS({
  "../node_modules/.pnpm/xz-decompress@0.2.3/node_modules/xz-decompress/dist/package/xz-decompress.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object")
        module.exports = factory(require_web());
      else if (typeof define === "function" && define.amd)
        define(["stream/web"], factory);
      else if (typeof exports === "object")
        exports["xz-decompress"] = factory(require_web());
      else
        root["xz-decompress"] = factory(root["stream/web"]);
    })(exports, (__WEBPACK_EXTERNAL_MODULE__2__) => {
      return (
        /******/
        (() => {
          "use strict";
          ...
          (() => {
            ...
            class XzContext {
              ...
              _refresh() {
                var _a;
                if (this.memory.buffer !== ((_a = this.mem8) == null ? void 0 : _a.buffer)) {
            ...
            const _XzReadableStream = class _XzReadableStream extends ReadableStream {
              static async _getModuleInstance() {
                ...
                const wasmOptions = {};
                const module2 = await WebAssembly.instantiate(wasmBytes, wasmOptions);
                _XzReadableStream._moduleInstance = module2.instance;
              }
              constructor(compressedStream) {
                ...
                super({
                  async start(controller) {
                    await _XzReadableStream._contextMutex.acquire();
                    try {
                      if (!_XzReadableStream._moduleInstance) {
                        await (_XzReadableStream._moduleInstancePromise || (_XzReadableStream._moduleInstancePromise = _XzReadableStream._getModuleInstance()));
                      }
                      xzContext = new XzContext(_XzReadableStream._moduleInstance);
                    } catch (error) {
                      _XzReadableStream._contextMutex.release();
                      throw error;
                    }
                  },
            ...
            __publicField(_XzReadableStream, "_moduleInstancePromise");
            __publicField(_XzReadableStream, "_moduleInstance");
            __publicField(_XzReadableStream, "_contextMutex", new ContextMutex());
            let XzReadableStream = _XzReadableStream;
          })();
...
export default require_xz_decompress();
/*! Bundled license information:

xz-decompress/dist/package/xz-decompress.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=xz-decompress.js.map
