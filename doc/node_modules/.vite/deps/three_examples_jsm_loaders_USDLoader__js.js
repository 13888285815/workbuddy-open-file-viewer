...
// ../node_modules/.pnpm/three@0.184.0/node_modules/three/examples/jsm/loaders/usd/USDAParser.js
...
var USDAParser = class {
  ...
  parseData(text) {
    ...
    specsByPath["/"] = { specType: SpecType2.Prim, fields: rootFields };
    const walkTree = (data, parentPath) => {
      ...
      for (const key in data) {
        ...
        if (defMatch) {
          ...
          this._extractPrimData(primData, path, primFields, specsByPath, SpecType2);
          specsByPath[path] = { specType: SpecType2.Prim, fields: primFields };
  ...
  _extractPrimData(data, path, primFields, specsByPath, SpecType2) {
    ...
    for (const key in data) {
      ...
      if (key.startsWith("rel ")) {
        ...
        specsByPath[relPath] = {
          specType: SpecType2.Relationship,
...
// ../node_modules/.pnpm/three@0.184.0/node_modules/three/examples/jsm/loaders/usd/USDCParser.js
...
// ../node_modules/.pnpm/three@0.184.0/node_modules/three/examples/jsm/loaders/usd/USDComposer.js
...
// ../node_modules/.pnpm/three@0.184.0/node_modules/three/examples/jsm/loaders/USDLoader.js
